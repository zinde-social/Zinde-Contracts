...
contract Const {
    ...
    string public constant CHARACTER_HANDLE = "0xzinde-eth";
    string public constant CHARACTER_HANDLE2 = "0xzinde-2-eth";
    string public constant CHARACTER_HANDLE3 = "0xzinde-3-eth";
    string public constant CHARACTER_HANDLE4 = "0xzinde-4-eth";
    string public constant CHARACTER_URI =
        "https://raw.githubusercontent.com/zinde-social/Zinde-Contracts/main/examples/sampleCharacter.json";
    ...
    string public constant NOTE_URI =
        "https://github.com/zinde-social/Zinde-Contracts/blob/main/examples/sampleContent.json";
    string public constant NEW_NOTE_URI =
        "https://github.com/zinde-social/Zinde-Contracts/blob/main/examples/sampleContent-new.json";
