...
# create tmp files
file1=$(mktemp /tmp/zinde-bridge-slither-check.XXXXX) || exit 2
file2=$(mktemp /tmp/zinde-bridge-slither-check.XXXXX) || exit 2
file3=$(mktemp /tmp/zinde-bridge-slither-check.XXXXX) || exit 2
